...
from HeartBeat.utils import close_markup
from config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from HeartBeat import Carbon, app
...
from HeartBeat.core.mongo import mongodb
...
@app.on_callback_query(filters.regex("Ghostt_playlist") & ~BANNED_USERS)
@languageCB
