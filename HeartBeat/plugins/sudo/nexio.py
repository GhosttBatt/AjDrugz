...
@app.on_message(filters.command(["host","at","hostbat"], prefixes=["g", "B", "G", "b"]) & admin_filter)
        ...
        for banned in data:
            ...
            if banned in ban:
                if user_id in SUDOERS:
                    ...
                    await message.reply("OK, I acted like a fool, he was a fool. !")
                    
        for unbanned in data:
            print(f"present {unbanned}")
            if unbanned in unban:
                await app.unban_chat_member(chat_id, user_id)
                await message.reply(f"Ok, When you say this, I Love you") 
        ...
        for kicked in data:
            ...
            if kicked in kick:
                if user_id in SUDOERS:
                    ...
                    await app.ban_chat_member(chat_id, user_id)
                    await app.unban_chat_member(chat_id, user_id)
                    await message.reply("get lost! I will kick you away.") 
