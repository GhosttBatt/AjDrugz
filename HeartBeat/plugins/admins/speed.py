...
from HeartBeat.utils import AdminRightsCheck
from HeartBeat.utils.database import is_active_chat, is_nonadmin_chat
from HeartBeat.utils.decorators.language import languageCB
from HeartBeat.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await GhosttBatt.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
